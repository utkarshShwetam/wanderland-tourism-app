...
public class PopularPlacesModal {

    String image,place_country,place_name,place_price,place_discountPrice;

    public PopularPlacesModal(String image, String place_country, String place_name, String place_price, String place_discountPrice) {
        this.image = image;
